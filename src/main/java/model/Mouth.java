...
//        }
    ...
    double inh_BB() {
        ...
        double SFa = subject.getSFa();
        double R = Math.pow (pSize, 2) * getFlowInh() * Math.pow( SFa, 2.3);
        double p = 1.152;
    ...
    double inh_bb() {
        ...
        double a = 0.1147;
        double R = (0.056 + Math.pow(tbInh(), 1.5)) * Math.pow( Math.pow( pSize, tbInh()), -0.25);
        double p = 1.173;
    ...
    double AI() {
        ...
        double a = 0.146  * Math.pow(subject.getSFa(), 0.96);
    ...
    double exh_BB() {
        ...
        double R = Math.pow(pSize, 2) * getFlowExh() * Math.pow(subject.getSFa(), 2.3);
        double p = 1.152;
        return 1 - Math.exp(-a * Math.pow(R, p));
    }
    ...
    double exh_ET() {
        ...
        double SFa = subject.getSFa();
        double R = Math.pow(pSize, 2) * Math.pow(getFlowExh() * Math.pow(SFa, 3), 0.6) * Math.pow(vol * Math.pow(SFa, 2), -0.2);
        double p = 1.4;
        return 1 - Math.exp(-a * Math.pow(R, p));
    }
    ...
    public void print(){
        ...
        System.out.println("ET inhalation (percentage): " + inh_ET());
        System.out.println("BB inhalation (percentage): " + inh_BB());
        System.out.println("bb inhalation (percentage): " + inh_bb());
        System.out.println("AI inh + exh  (percentage): " + AI());
        System.out.println("bb exhalation (percentage): " + exh_bb());
        System.out.println("BB exhalation (percentage): " + exh_BB());
        System.out.println("ET exhalation (percentage): " + exh_ET());
    ...
    double Tinh_ET(){
       double a = 9;
       double R = D() * Math.pow(getFlowInh() * subject.getSFa(), -0.25);
       double p = 0.5;
    ...
    double Tinh_bb(){
        double a = -76.8 + ( 167 * Math.pow(subject.getSFa(), 0.65 ) );
        double R = D() * tbInh();
        double p = 0.5676;
    ...
    double T_AI() {
        double a = 170 + ( 103 * Math.pow( subject.getSFa(), 2.13 ) );
        double R = D() * ta();
        double p = 0.6101;
